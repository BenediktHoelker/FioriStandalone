sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("ts/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("ts.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["ts/localService/mockserver"], function (mockserver) {
